...
<head>
    ...
    <title>403 - Truy cập bị từ chối | {{siteinfo('site_name')}}</title>
    <link rel="stylesheet" href="{{asset('static/system/errors/403/style.min.css')}}">
</head>
<body>
    <header class="intro">
        <h1 class="intro__headline">403</h1>
        <p class="intro__subhead">Bạn không có quyền truy cập mục này!</p>
    </header>
    ...
    <script src="{{asset('static/system/errors/403/script.js')}}"></script>
