@php
    $data = $options->theme->products->makeByPrefix('suggest_');
    $styles = [];
    ...
    <div class="section section-personal-styles ovxh section-default section-large">
        <div class="container container-max">
            ...
            <div class="section-content wtf-slide">
                ...
                <div class="btns mt-12 mt-lg-20 mt-xxl-40 mb-12 mb-lg-20 mb-xxl-40 text-center">
                    <a href="/tao-style-ca-nhan.html" class="btn btn-def-size btn-theme-color">Tạo style của riêng bạn</a>
                </div>
                <div class="style-products">
                    ...
                    <div class="pt-20 pt-lg-30">
                        ...
                        {{-- @include($_template.'products.slides', [
                            ...
                            'seemore' => route('client.products', $routeParams),
