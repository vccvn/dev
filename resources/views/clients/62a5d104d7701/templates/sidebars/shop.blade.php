@php
    ...
    add_js_data('filter_data', [
        'search_url' => route('client.products')
    ])
@endphp
                    ...
                    <div class="search-wrapper">
                        <div class="search-group">
                            <div class="input-group">
                                ...
                                <input type="text" name="keyword" class="form-control search-input" placeholder="Tìm kiếm phong cách cá nhân" value="{{$request->keyword}}">

                            </div>
                        </div>
                        <button type="submit" class="btn btn-outline-default">Tìm kiếm</button>
                    </div>
                </div>
