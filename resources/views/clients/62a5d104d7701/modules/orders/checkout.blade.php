                        ...
                        <div class="col-md-7">
                            <form action="{{route('client.orders.checkout')}}" method="POST" class="form form--cart {{parse_classname('checkout-form', 'cart-form', 'cart-section')}}" data-cart-type="{{$cart->type}}" data-cart-id="{{$cart->id}}">
                                ...
                                <div class="production">
                                    <ul class="box-policy">
                                        <li>
                                            <img src="{{theme_asset('images/custom/cart/icon-delivery-truck.png')}}" alt="icon-delivery-truck"
                                                srcset="" />
                                            <span>Miễn phí giao hàng</span>
                                        </li>
                                        <li>
                                            <img src="{{theme_asset('images/custom/cart/icon-hand-cart.png')}}" alt="icon-hand-cart"
                                                srcset="" />
                                                ...
                                                <div class="product-details col-lg-8 col-md-8 mt-md-0">
                                                    <div class="row">
                                                        <div class="cart-item-info-left">
                                                            ...
                                                            <p class="material_size d-none d-md-block">
                                                                @if ($item->attributes && count($item->attributes))
                                                                    ...
                                                                    <span data-item-attribute-id="{{$attr->attribute_id}}" class="{{parse_classname('cart-item-attribute', 'cart-item-attribute-selected', 'cart-item-attribute-value-'.$attr->attribute_id)}}">{{$attr->text}}</span>
                                                                        @if (!$loop->last)
                                                                            / 
                                                                        @endif
                                                                    @endforeach
                                                        ...
                                                        <div class="cart-item-info-right">
                                                            ...
                                                            <p class="price-sale {{parse_classname('item-total-price')}}">{{$item->getPriceFormat('total')}}</p>
                                                        </div>
                                                            ...
                                                            @foreach ($item->attributes as $attr)
                                                                ...
                                                                <div class="col-md-6 mt-15">
                                                                    ...
                                                                    <select class="form-select t-form-select {{parse_classname('cart-item-attribute')}}" data-item-id="{{ $item->id }}"  name="attr[{{$item->id}}][]" id="cart-item-attr-{{$itemOption->attribute_id}}">
                                                                        ...
                                                                        <option value="{{$attrVal->value_id}}" @if ($attrVal->value_id == $attr->value_id)
                                                                            selected
                                                                        @endif>{{$attrVal->text}}</option>
                                                                        @endforeach
                                ...
                                <div class="box-info">
                                    ...
                                    <form  action="{{route('client.orders.place-order')}}" method="POST" class="form form--cart {{parse_classname('checkout-form', 'placeh-order-form', 'cart-section')}}">
                                        ...
                                        <div class="card box-cart">
                                            ...
                                            <div class="row apply-voucher"> 
                                                <div class="col-md-9 mr-input">
