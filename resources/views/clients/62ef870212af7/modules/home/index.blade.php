...
============================================ -->
    ...
    <link rel="stylesheet" href="{{theme_asset('css/vendor/icomoon.css')}}">
    <link rel="stylesheet" href="{{theme_asset('css/vendor/remixicon.css')}}">
    <link rel="stylesheet" href="{{theme_asset('css/vendor/magnifypopup.css')}}">
    <link rel="stylesheet" href="{{theme_asset('css/vendor/slick.css')}}">
    <link rel="stylesheet" href="{{theme_asset('css/vendor/odometer.css')}}">
    <link rel="stylesheet" href="{{theme_asset('css/vendor/lightbox.css')}}">
    <link rel="stylesheet" href="{{theme_asset('css/vendor/animation.css')}}">
    <link rel="stylesheet" href="{{theme_asset('css/vendor/jqueru-ui-min.css')}}">
    <link rel="stylesheet" href="{{theme_asset('css/vendor/swiper-bundle.min.css')}}">
    <link rel="stylesheet" href="{{theme_asset('css/vendor/tipped.min.css')}}">
...
<body class="sticky-header">
    ...
    <div id="main-wrapper" class="main-wrapper">
        ...
        <header class="edu-header header-style-1 header-fullwidth">
                    ...
                    <div class="header-top">
                        ...
                        <div class="header-top-right">
                            <ul class="header-info">
                                ...
                                <li><a href="mailto:info@edublink.com"><i class="icon-envelope"></i>Email: info@edublink.com</a></li>
                ...
                <div class="container-fluid">
                    <div class="header-navbar">
                        <div class="header-brand">
                            <div class="logo">
                                <a href="index.html">
                                    <img class="logo-light" src="{{theme_asset('images/logo/logo-dark.png')}}" alt="Corporate Logo">
                                </a>
                            </div>
            ...
            <div class="popup-mobile-menu">
                <div class="inner">
                    <div class="header-top">
                        <div class="logo">
                            <a href="index.html">
                                <img src="{{theme_asset('images/logo/logo-dark.png')}}" alt="Corporate Logo">
                            </a>
                        </div>
            ...
            <div class="edu-search-popup">
                <div class="content-wrap">
                    <div class="site-logo">
                        <img src="{{theme_asset('images/logo/logo-dark.png')}}" alt="Logo">
                    </div>
                    ...
                    <div class="col-lg-6">
                        <div class="banner-thumbnail">
                            <div class="thumbnail" data-sal-delay="500" data-sal="slide-left" data-sal-duration="1000">
                                <img src="{{theme_asset('images/banner/girl-1.png')}}" alt="Girl Image">
                            </div>
                            <div class="instructor-info" data-sal-delay="600" data-sal="slide-up" data-sal-duration="1000">
                                <div class="inner">
                                    ...
                                    <div class="media">
                                        <div class="thumb">
                                            <img src="{{theme_asset('images/banner/author-1.png')}}" alt="Images">
                                        </div>
                                        <div class="content">
        ...
        <div class="edu-categorie-area categorie-area-1 edu-section-gap">
            <div class="container">
                <div class="section-title section-center" data-sal-delay="150" data-sal="slide-up" data-sal-duration="800">
                    ...
                    <h2 class="title">Detailed Information on IELTS</h2>
                    <span class="shape-line"><i class="icon-19"></i></span>
                    <p>IELTS is a universally accepted English language proficiency test that evaluates a candidate's English language skills. This test is mainly designed for non-native English speakers who wish to migrate, study, or work in dominant English-speaking countries.
                        <br> IELTS tests an aspirant's English skills in all four modules, namely, Listening, Reading, Writing, and Speaking, on a nine-band scale.</p>
                </div>
                <div class="section-title section-center" data-sal-delay="150" data-sal="slide-up" data-sal-duration="800">
                    {{-- <h2 class="title">Online <span class="color-primary">Classes</span> For Remote Learning.</h2> --}}
                    <h2 class="title">
                        Know about the IELTS Exam Preparation
                    </h2>
                ...
                <div class="row g-5">
                    <div class="col-lg-4 col-sm-6" data-sal-delay="100" data-sal="slide-up" data-sal-duration="800">
                        <div class="categorie-grid categorie-style-1 color-primary-style edublink-svg-animate">
                            <div class="icon">
                                <img class="svgInject" src="{{theme_asset('images/animated-svg-icons/online-degree.svg')}}" alt="animated icon">
                                <!-- <i class="icon-9"></i> -->
                            </div>
                            <div class="content">
                                <h5 class="title">IELTS Exam Types</h5>
                                <p>
                                    <strong>IELTS Exam is conducted in two types:</strong> <br>
                                    IELTS Academic and IELTS General.<br class="d-none d-md-block"> Know more about the details here.
                                </p>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4 col-sm-6" data-sal-delay="200" data-sal="slide-up" data-sal-duration="800">
                        <div class="categorie-grid categorie-style-1 color-secondary-style edublink-svg-animate">
                            <div class="icon">
                                <img class="svgInject" src="{{theme_asset('images/animated-svg-icons/non-degree-programs.svg')}}" alt="animated icon">
                                <!-- <i class="icon-10"></i> -->
                            </div>
                            <div class="content">
                                <h5 class="title">IELTS Test Formats</h5>
                                <p>
                                    Find out the details of each module, <br class="d-none d-md-block">exam time frame,
                                    types of questions, and<br class="d-none d-md-block">much more. All that you need to
                                    know!
                                </p>
                            </div>
                        </div>
                    ...
                    <div class="col-lg-4 col-sm-6" data-sal-delay="300" data-sal="slide-up" data-sal-duration="800">
                        <div class="categorie-grid categorie-style-1 color-extra08-style edublink-svg-animate">
                            ...
                            <div class="content">
                                <h5 class="title">Exam Delivery Method</h5>
                                <p>
                                    Thanks to technology, now there is <br class="d-none d-md-block"><a href="/paper-based-exam">
                                        Paper-Based IELTS
                                    </a> and <a href="/computer-based-exam">Computer-Delivered IELTS</a>.
                                    <br class="d-none d-md-block"> Check out how they both are different.
                                </p>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row g-5 align-items-center">
                    <div class="col-lg-6">
                        <div class="about-image-gallery">
                            <img class="main-img-1" src="{{theme_asset('images/about/about-01.jpg')}}" alt="About Image">
                            <div class="video-box" data-sal-delay="150" data-sal="slide-down" data-sal-duration="800">
                                <div class="inner">
                                    <div class="thumb">
                                        <img src="{{theme_asset('images/about/about-02.jpg')}}" alt="About Image">
                    ...
                    <div class="col-lg-6" data-sal-delay="150" data-sal="slide-left" data-sal-duration="800">
                        <div class="about-content">
                            <div class="section-title section-left">
                                <span class="pre-title">Giới thiệ</span>
                                <h2 class="title">Học IELTS từ con số 0 <span class="color-secondary">Anywhere</span></h2>
                                <span class="shape-line"><i class="icon-19"></i></span>
                            ...
                            <ul class="features-list">
                                <li>Slogan 1: Lorem ipsum dolor sit amet consectetur </li>
                                <li>Slogan 2: Lorem ipsum dolor sit amet consectetur </li>
                                <li>Slogan 3: Lorem ipsum dolor sit amet consectetur </li>
                                <li>Slogan 4: Lorem ipsum dolor sit amet consectetur </li>
                    ...
                    <div class="col-lg-5">
                        <div class="brand-section-heading">
                            <div class="section-title section-left" data-sal-delay="150" data-sal="slide-up" data-sal-duration="800">
                                <span class="pre-title">Lộ trình</span>
                                <h2 class="title">Lộ trình BreakingIELTS</h2>
                                <span class="shape-line"><i class="icon-19"></i></span>
                        ...
                        <table class="table table-bordered">
                            <thead>
                                <tr>
                                    ...
                                    <th class="text-center">Đảm bảo đầu ra</th>
                                    <th class="text-center">Thời gian</th>
                                </tr>
                            </thead>
                            <tbody>
                                <tr>
                                    <td class="text-center">Pre - Ielts</td>
                                    <td class="text-center">Foundation</td>
                                    <td class="text-right">No</td>
                                    <td class="text-center">6 tháng</td>
                                </tr>
                                <tr>
                                    <td rowspan="6" class="text-center">Background Ielts</td>
                                    <td class="text-center">Background Ielts 1</td>
                                    <td class="text-right">3.0</td>
                                    <td class="text-center">6 tháng</td>
                                </tr>
                                <tr>
                                    <td class="text-center">Background Ielts 2</td>
                                    <td class="text-right">3.5</td>
                                    <td class="text-center">6 tháng</td>
                                </tr>
                                <tr>
                                    <td class="text-center">Background Ielts 3</td>
                                    <td rowspan="2" class="text-right">4.0</td>
                                    <td class="text-center">6 tháng</td>
                                </tr>
                                <tr>
                                    <td class="text-center">Background Ielts 4</td>
                                    <td class="text-center">6 tháng</td>
                                </tr>
                                <tr>
                                    <td class="text-center">Background Ielts 5</td>
                                    <td rowspan="2" class="text-right">4.5</td>
                                    <td class="text-center">6 tháng</td>
                                </tr>
                                <tr>
                                    <td class="text-center">Background Ielts 6</td>
                                    <td class="text-center">6 tháng</td>
                                </tr>
                                
                                {{-- Breaking --}}
                                <tr>
                                    <td rowspan="6" class="text-center">Breaking Ielts</td>
                                    <td class="text-center">Breaking Ielts 1</td>
                                    <td class="text-right">5.0</td>
                                    <td class="text-center">6 tháng</td>
                                </tr>
                                <tr>
                                    <td class="text-center">Breaking Ielts 2</td>
                                    <td class="text-right">5.5</td>
                                    <td class="text-center">6 tháng</td>
                                </tr>
                                <tr>
                                    <td class="text-center">Breaking Ielts 3</td>
                                    <td class="text-right">6.0</td>
                                    <td class="text-center">6 tháng</td>
                                </tr>
                                <tr>
                                    <td class="text-center">Breaking Ielts 4</td>
                                    <td rowspan="2" class="text-right">6.5</td>
                                    <td class="text-center">6 tháng</td>
                                </tr>
                                <tr>
                                    <td class="text-center">Breaking Ielts 5</td>
                                    <td class="text-center">6 tháng</td>
                                </tr>
                                <tr>
                                    <td class="text-center">Breaking Ielts 6</td>
        ...
        <div class="edu-course-area course-area-1 edu-section-gap bg-lighten01">
            <div class="container">
                <div class="section-title section-center" data-sal-delay="150" data-sal="slide-up" data-sal-duration="800">
                    <span class="pre-title">Các khóa học</span>
                    <h2 class="title">Hãy bắt đầu cùng Breaking IELTS</h2>
                    <span class="shape-line"><i class="icon-19"></i></span>
                </div>
                <div class="row g-5">
                    <!-- Start Single Course  -->
                            ...
                            <div class="inner">
                                <div class="thumbnail">
                                    <a href="course-details.html">
                                        <img src="{{theme_asset('images/course/course-07.jpg')}}" alt="Course Meta">
                                    </a>
                                    <div class="time-top">
                    ...
                    <div class="col-md-6 col-xl-3" data-sal-delay="150" data-sal="slide-up" data-sal-duration="800">
                        <div class="edu-course course-style-1 hover-button-bg-white">
                            <div class="inner">
                                <div class="thumbnail">
                                    <a href="course-details.html">
                                        <img src="{{theme_asset('images/course/course-04.jpg')}}" alt="Course Meta">
                                    </a>
                                    <div class="time-top">
                    ...
                    <div class="col-md-6 col-xl-3" data-sal-delay="150" data-sal="slide-up" data-sal-duration="800">
                        <div class="edu-course course-style-1 hover-button-bg-white">
                            <div class="inner">
                                <div class="thumbnail">
                                    <a href="course-details.html">
                                        <img src="{{theme_asset('images/course/course-05.jpg')}}" alt="Course Meta">
                                    </a>
                                    <div class="time-top">
                    ...
                    <div class="col-md-6 col-xl-3" data-sal-delay="150" data-sal="slide-up" data-sal-duration="800">
                        <div class="edu-course course-style-1 hover-button-bg-white">
                            <div class="inner">
                                <div class="thumbnail">
                                    <a href="course-details.html">
                                        <img src="{{theme_asset('images/course/course-06.jpg')}}" alt="Course Meta">
                                    </a>
                                    <div class="time-top">
        ...
        <div class="edu-blog-area blog-area-3 edu-section-gap">
            <div class="container">
                <div class="section-title section-center" data-sal-delay="50" data-sal="slide-up" data-sal-duration="800">
                    <span class="pre-title">Video</span>
                    <h2 class="title">Cùng học với Breaking IELTS</h2>
                    <span class="shape-line"><i class="icon-19"></i></span>
                </div>
                            ...
                            <div class="inner">
                                <div class="thumbnail">
                                    <a href="blog-details.html">
                                        <img src="{{theme_asset('images/blog/blog-04.jpg')}}" alt="Blog Images">
                                    </a>
                                </div>
                                <div class="content">
                                    <div class="blog-date">
                    ...
                    <div class="col-lg-6" data-sal-delay="100" data-sal="slide-up" data-sal-duration="800">
                        <div class="edu-blog blog-style-2">
                            <div class="inner">
                                <div class="thumbnail">
                                    <a href="blog-details.html">
                                        <img src="{{theme_asset('images/blog/blog-05.jpg')}}" alt="Blog Images">
                                    </a>
                                    <div class="blog-date">
                                        <span class="day">27</span>
                                        <span class="month">SEP</span>
                        ...
                        <div class="edu-blog blog-style-2">
                            <div class="inner">
                                <div class="thumbnail">
                                    <a href="blog-details.html">
                                        <img src="{{theme_asset('images/blog/blog-06.jpg')}}" alt="Blog Images">
                                    </a>
                                    <div class="blog-date">
                        ...
                        <div class="edu-blog blog-style-2">
                            <div class="inner">
                                <div class="thumbnail">
                                    <a href="blog-details.html">
                                        <img src="{{theme_asset('images/blog/blog-10.jpg')}}" alt="Blog Images">
                                    </a>
                                    <div class="blog-date">
                                ...
                                <div class="thumbnail-wrap">
                                    <div class="thumbnail">
                                        <a href="team-details.html">
                                            <img src="{{theme_asset('images/team/team-01.jpg')}}" alt="team images">
                                        </a>
                                    </div>
                        ...
                        <div class="edu-team-grid team-style-1">
                            <div class="inner">
                                <div class="thumbnail-wrap">
                                    <div class="thumbnail">
                                        <a href="team-details.html">
                                            <img src="{{theme_asset('images/team/team-02.jpg')}}" alt="team images">
                                        </a>
                                    </div>
                                    <ul class="team-share-info">
                                        <li><a href="#"><i class="icon-share-alt"></i></a></li>
                        ...
                        <div class="edu-team-grid team-style-1">
                            <div class="inner">
                                <div class="thumbnail-wrap">
                                    <div class="thumbnail">
                                        <a href="team-details.html">
                                            <img src="{{theme_asset('images/team/team-03.jpg')}}" alt="team images">
                                        </a>
                                    </div>
                                    <ul class="team-share-info">
                                        <li><a href="#"><i class="icon-share-alt"></i></a></li>
                        ...
                        <div class="edu-team-grid team-style-1">
                            <div class="inner">
                                <div class="thumbnail-wrap">
                                    <div class="thumbnail">
                                        <a href="team-details.html">
                                            <img src="{{theme_asset('images/team/team-04.jpg')}}" alt="team images">
                                        </a>
                                    </div>
                                    <ul class="team-share-info">
                                        <li><a href="#"><i class="icon-share-alt"></i></a></li>
                    ...
                    <div class="col-lg-8">
                        <div class="counterup-box-wrap">
                            ...
                            <ul class="shape-group">
                                ...
                                <li class="shape-2">
                                    <img class="rotateit" src="{{theme_asset('images/counterup/shape-02.png')}}" alt="Shape">
                                </li>
                                <li class="shape-3 scene">
                                    <img data-depth="1" src="{{theme_asset('images/counterup/shape-04.png')}}" alt="Shape">
                                </li>
                                <li class="shape-4 scene">
                                    <img data-depth="-1" src="{{theme_asset('images/counterup/shape-05.png')}}" alt="Shape">
                                </li>
                            </ul>
                        </div>
                    </div>
                            ...
                            <div class="row g-5">
                                <div class="col-6" data-sal-delay="50" data-sal="slide-right" data-sal-duration="800">
                                    <div class="faq-thumbnail thumbnail-1">
                                        <img src="{{theme_asset('images/faq/faq-01.jpg')}}" alt="Faq Images">
                                    </div>
                                </div>
                                <div class="col-6" data-sal-delay="100" data-sal="slide-left" data-sal-duration="800">
                                    <div class="faq-thumbnail thumbnail-2">
                                        <img src="{{theme_asset('images/faq/faq-02.jpg')}}" alt="Faq Images">
                                    </div>
                                </div>
                                <div class="col-6" data-sal-delay="50" data-sal="slide-right" data-sal-duration="800">
                                    <div class="faq-thumbnail thumbnail-3">
                                        <img src="{{theme_asset('images/faq/faq-03.jpg')}}" alt="Faq Images">
                                    </div>
                                </div>
                                <div class="col-6" data-sal-delay="100" data-sal="slide-left" data-sal-duration="800">
                                    <div class="faq-thumbnail thumbnail-4">
                                        <img src="{{theme_asset('images/faq/faq-04.jpg')}}" alt="Faq Images">
                                    </div>
                                </div>
                            </div>
                            <ul class="shape-group">
                        ...
                        <div class="home-one-cta edu-cta-box bg-image bg-image--7">
                            <div class="inner">
                                <div class="content text-md-end">
                                    ...
                                    <h3 class="title"><a href="mailto:info@edublink">Breakingielts@gmail.com</a></h3>
                                </div>
                                <div class="sparator">
                                    <span>Hoặc</span>
                                </div>
                                <div class="content">
                                    ...
                                    <h3 class="title"><a href="tel:+011235641231">+0945 758 158</a></h3>
                                </div>
                            </div>
                            <ul class="shape-group">
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-5">
                        <div class="brand-section-heading">
                            <div class="section-title section-left" data-sal-delay="150" data-sal="slide-up" data-sal-duration="800">
                                <span class="pre-title">Hợp tác</span>
                                <h2 class="title">Đối tác của BreakingIELTS</h2>
                                <span class="shape-line"><i class="icon-19"></i></span>
                                <p>Lorem ipsum dolor sit amet consectur adipiscing elit sed eiusmod tempor incididunt.</p>
                            </div>
                        </div>
        ...
        <div class="edu-blog-area blog-area-2 svg-image--2 bg-image gap-bottom-equal">
            <div class="container">
                <div class="section-title section-center" data-sal-delay="100" data-sal="slide-up" data-sal-duration="800">
                    <span class="pre-title">MỚI CẬP NHẬT</span>
                    <h2 class="title">Tin tức BreakingIELTS</h2>
                    <span class="shape-line"><i class="icon-19"></i></span>
                </div>
                <div class="row g-5">
                    <!-- Start Blog Grid  -->
                    <div class="col-lg-4 col-md-6 col-12" data-sal-delay="100" data-sal="slide-up" data-sal-duration="800">
                        <div class="edu-blog blog-style-1">
                            <div class="inner">
                                <div class="thumbnail">
                                    <a href="blog-details.html">
                                        <img src="{{theme_asset('images/blog/blog-01.jpg')}}" alt="Blog Images">
                                    </a>
                                </div>
                    ...
                    <div class="col-lg-4 col-md-6 col-12" data-sal-delay="200" data-sal="slide-up" data-sal-duration="800">
                        <div class="edu-blog blog-style-1">
                            <div class="inner">
                                <div class="thumbnail">
                                    <a href="blog-details.html">
                                        <img src="{{theme_asset('images/blog/blog-02.jpg')}}" alt="Blog Images">
                                    </a>
                                </div>
                                <div class="content position-top">
                                    <div class="read-more-btn">
                    ...
                    <div class="col-lg-4 col-md-6 col-12" data-sal-delay="300" data-sal="slide-up" data-sal-duration="800">
                        <div class="edu-blog blog-style-1">
                            <div class="inner">
                                <div class="thumbnail">
                                    <a href="blog-details.html">
                                        <img src="{{theme_asset('images/blog/blog-03.jpg')}}" alt="Blog Images">
                                    </a>
                                </div>
                                <div class="content position-top">
                                    <div class="read-more-btn">
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="inner text-center">
                                <p>Copyright 2022 <a href="#">EduBlink</a> Designed By <a href="https://themeforest.net/user/devsblink">DevsBlink</a>. All Rights Reserved</p>
                            </div>
                        </div>
                    </div>
                </div>
