...
use App\Validators\Menus\ItemValidator;
use App\Validators\Menus\SortItemValidator;
...
class ItemRepository extends BaseRepository
{
     ...
     */
    protected $validatorClass = ItemValidator::class;
    ...
    public function getInputGroup()
    {
        ...
        elseif(in_array($webType, ['personal', 'business'])){
            // trang gioi thieu
     ...
     * @return array
     */
    public function createItems($items = [], int $menu_id = 0, int $parent_id = 0)
    {
        $menuItems = [];
        if(count($items)){
            $a = new Arr([]);
