 ...
 * 
 */
use App\Validators\Teams\MemberValidator;
use App\Masks\Teams\TeamMemberMask;
use App\Masks\Teams\TeamMemberCollection;
class MemberRepository extends BaseRepository
{
     ...
     */
    protected $validatorClass = MemberValidator::class;
    /**
     * tên class mặt nạ. Thường có tiền tố [tên thư mục] + \ vá hậu tố Mask
     *
     * @var string
     */
    protected $maskClass = TeamMemberMask::class;
     ...
     * @var string
     */
    protected $maskCollectionClass = TeamMemberCollection::class;
