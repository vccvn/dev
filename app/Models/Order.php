...
class Order extends Model
{
    ...
    const STATUS_SLUGS = [
        ...
        self::PENDING           => "pending",              // đang xử lý
        self::PROCESSING        => "processing",           // đã hoàn thành
    ...
    public $table = 'orders';
    public $fillable = ['user_id', 'customer_id', 'promo_id', 'secret_id', 'code', 'type', 'ship_to_different_address', 'payment_method_id', 'shipping_fee', 'tax', 'coupon', 'promo_type', 'sub_total', 'promo_total', 'total_money', 'note', 'status', 'payment_status', 'delivery_status', 'trashed_status', 'completed_at', 'ordered_at'];
