...
class Product extends Model
{
    ...
    public function promos()
    {
        ...
        ->select(
                'product_refs.*', 
                'promos.name', 'promos.description', 'promos.scope', 'promos.type', 'promos.down_price', 'promos.code', 
                'promos.quantity_per_user', 'promos.limited_total', 'promos.usage_total', 'promos.started_at', 'promos.finished_at', 
                'promos.is_activated'
            );
    }
    ...
    public function getOrderOptionData()
    {
        return $this->parseAttributeData($this->orderOptions, 1);
    }
