...
class PermissionRole extends Model
{
    ...
    {
        return $this->roleUsers()->join('users', 'users.id', '=', 'permission_user_roles.user_id')->select('permission_user_roles.user_id', 'permission_user_roles.role_id', 'users.id', 'users.name', 'users.email', 'users.username', 'users.avatar');
    }
