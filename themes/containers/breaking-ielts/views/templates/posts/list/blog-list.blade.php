...
@endphp
<div class="edu-blog blog-style-list {{$isVideo?'post-video':'' }}" data-sal-delay="150" data-sal="slide-up" data-sal-duration="800">
    <div class="inner">
        <div class="thumbnail">
            <a href="{{$url}}">
        ...
        <div class="content">
            ...
            <h5 class="title"><a href="{{$url}}">{{$post->title}}</a></h5>
            <ul class="blog-meta">
