...
@endphp
        ...
        <header class="edu-header header-style-1 header-fullwidth">
            @if ($header->show_topbar)
                @if ($header->topbar_background_color != '#1f2432')
                    <style>
                        .header-top-bar {
                            background-color: {{$header->topbar_background_color}};
                        }
                    </style>
                @endif
                @if ($header->topbar_text_color != '#fff')
                    <style>
                        .header-top .header-notify, .header-top .header-notify p, .header-top .header-info li a {
                            color: {{$header->topbar_text_color}};
                        }
                    </style>
                @endif
                @if ($header->topbar_link_color != '#ee4a62')
                    <style>
                        .header-top .header-info li i, .header-top .header-info li a:hover {
                            color: {{$header->topbar_text_color}};
                        }
