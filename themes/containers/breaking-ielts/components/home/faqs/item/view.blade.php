<div class="accordion-item">
    <h5 class="accordion-header">
        <button class="accordion-button {{$data->index == 0 ? '' : 'collapsed'}}" type="button" data-bs-toggle="collapse" data-bs-target="#collapse-{{$data->index+1}}" aria-expanded="{{$data->index == 0 ? 'true' : 'false'}}">
            {{$data->title}}
        </button>
    </h5>
